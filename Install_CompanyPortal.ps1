<#
.DESCRIPTION
This Script Installes the Company Portal App with an OfflineInstaller
...
$ScriptVersion = "006"
$ScriptName = "Install_CompanyPortal"
$AppxBundle = "Microsoft.CompanyPortal_2018.319.702.0_neutral_~_8wekyb3d8bbwe.AppxBundle"
$License = "Microsoft.CompanyPortal_8wekyb3d8bbwe_58a1808e-9398-4976-1a05-fc884e16f609.xml"
...
try{
    ...
    Add-ProvisionedAppxPackage -PackagePath "$ScriptPath\$AppxBundle" -LicensePath "$ScriptPath\$License" -DependencyPackagePath $Dependencies.FullName -Online -ErrorAction Stop
} catch {
